...
export default function DocsPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', position: 'relative', zIndex: 2 }}>
      ...
      {/* Top bar */}
      <header style={{ position: 'sticky', top: 0, zIndex: 100, background: 'var(--nav-bg)', backdropFilter: 'blur(14px)', borderBottom: '1px solid var(--line)', height: 50, display: 'flex', alignItems: 'center', padding: '0 20px', gap: 12 }}>
