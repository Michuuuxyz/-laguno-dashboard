...
const IconGrid    = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="3" width="8" height="8" rx="2.2" opacity=".35"/><rect x="13" y="3" width="8" height="8" rx="2.2" opacity=".35"/><rect x="3" y="13" width="8" height="8" rx="2.2" opacity=".35"/><rect x="13" y="13" width="8" height="8" rx="2.2"/></svg>;
const IconShield  = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2l7.5 2.9a1 1 0 0 1 .6 1v5.4c0 4.9-3.3 8.4-7.8 9.9a1 1 0 0 1-.6 0C7.2 19.9 3.9 16.4 3.9 11.5V6.1a1 1 0 0 1 .6-1z" opacity=".35"/><path d="M10.6 13.2l-1.7-1.7-1.5 1.5 3.2 3.2 5.3-5.3-1.5-1.5z"/></svg>;
const IconBolt    = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 2.2 3.6 14a.7.7 0 0 0 .5 1.1H9l-1 6.3a.6.6 0 0 0 1.1.4L20.4 10a.7.7 0 0 0-.5-1.1H15z" opacity=".35"/><path d="M13.5 2.2 3.6 14a.7.7 0 0 0 .5 1.1H9z"/></svg>;
const IconUsers   = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><circle cx="16" cy="8" r="3" opacity=".35"/><path d="M11.5 20.5a5 5 0 0 1 9.5-2.2.9.9 0 0 1-.8 1.3h-8.2a.6.6 0 0 1-.5-.9z" opacity=".35"/><circle cx="9" cy="8" r="3.7"/><path d="M3 20.6a6 6 0 0 1 12 0 .8.8 0 0 1-.8.8H3.8a.8.8 0 0 1-.8-.8z"/></svg>;
const IconTag     = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M11.7 3.4A2 2 0 0 0 10.3 3H5.4a2 2 0 0 0-2 2v4.9a2 2 0 0 0 .6 1.4l8 8a2 2 0 0 0 2.8 0l4.9-4.9a2 2 0 0 0 0-2.8z" opacity=".35"/><circle cx="7.7" cy="7.7" r="1.9"/></svg>;
const IconFile    = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M6 3h7.2L19 8.8V20a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1z" opacity=".35"/><path d="M13 3v5a1 1 0 0 0 1 1h5" opacity=".55"/><rect x="8" y="12" width="8" height="1.9" rx=".95"/><rect x="8" y="15.6" width="8" height="1.9" rx=".95"/></svg>;
const IconWarn    = () => <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M10.3 3.6 1.9 18a1.6 1.6 0 0 0 1.4 2.4h17.4a1.6 1.6 0 0 0 1.4-2.4L13.7 3.6a1.6 1.6 0 0 0-2.8 0z" opacity=".35"/><rect x="11" y="8.5" width="2" height="5.5" rx="1"/><circle cx="12" cy="17" r="1.3"/></svg>;
